...
watch(() => props.token, async (newProps) => {
  if (newProps?.id.toString() === '0' || !props?.token?.id) {
    return
  }
  ...
  >
    <div
      class="
        ...
        bg-gray-800 rounded-[8px] px-4 py-3 relative z-[0]
      "
    >
      <button
      ...
      >
        ...
        <div>
          <Icon
            name="chevron"
            class="w-4 h-4 container transition-all duration-500"
      ...
      <CollapsibleCollapseTransition>
        <div
          v-show="state.show && !disabled"
        >
          <div
            class="flex items-center justify-between pt-[12px]"
          >
            <div>
              <span
          ...
          >
            ...
            >
              ...
              <div
                class="line-clamp-2 text-font-1 max-w-[106px]"
              >
                <span
          ...
          >
            ...
            <div
              v-if="state.datum"
              :title="state.datum?.title"
              class="flex justify-end items-center space-x-2 w-full pt-[12px]"
            >
              <div>
                <img
                  loading="lazy"
