  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".07" stop-color="#0f0f36"></stop>
        <stop offset=".76" stop-color="#232371"></stop>
      </linearGradient>
      <linearGradient
        id="tail_gradient"
        x1="325.11"
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#0f0f36"></stop>
        <stop offset=".8" stop-color="#232371"></stop>
      </linearGradient>
      <linearGradient
      ...
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stop-color="#479ff5"></stop>
        <stop offset=".22" stop-color="#405ee5"></stop>
        <stop offset=".35" stop-color="#523bda"></stop>
        <stop offset=".43" stop-color="#5a55ce"></stop>
        <stop offset=".56" stop-color="#5a55ce"></stop>
        <stop offset=".76" stop-color="#3b3cbb"></stop>
        <stop offset=".87" stop-color="#171e9b"></stop>
        <stop offset="1" stop-color="#171e9b"></stop>
      </linearGradient>
    </defs>
    <g id="main_logo">
      <g id="outer_tails">
