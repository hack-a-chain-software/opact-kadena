...
export const computeWihtdrawParams = async ({
  ...
  const { extData, message } = computeTransactionParams({
    batch,
    receiver,
    selectedToken,
    receiptsParams,
...
export const computePaymentParams = async ({
  ...
  wallet = {
    pubkey:
      '11266420894616539307519683389038109246654130435849311470670815520318096498921',
    pvtkey:
      '1482393132684423265528213543145697981060187089163992385907820405516567711584'
  }
}: any) => {
  const batch = await getDepositSoluctionBatch({
    selectedToken,
